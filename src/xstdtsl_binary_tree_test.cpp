...
int main(int i_nNum_Params, char * i_pParams[])
{
	...
	std::cout << "construct safe_binary_tree with default constructor for base type int" << std::endl;
	{
		xstdtsl::safe_binary_tree<int> cTI;
	...
	}
	{
		...
		xstdtsl::safe_binary_tree<int>::read_iterator cIter(cTI,xstdtsl::safe_binary_tree<int>::iterator_base::start_point::beginning);
		...
		cIter.set_position(xstdtsl::safe_binary_tree<int>::iterator_base::start_point::root);
		std::cout << "confirm iterator is valid" << std::endl;
		assert(cIter.is_valid());
		...
		cIter.set_position(xstdtsl::safe_binary_tree<int>::iterator_base::start_point::end);
		std::cout << "confirm iterator is valid" << std::endl;
		assert(cIter.is_valid());
	...
	}
	{
		...
		assert(cTI.has_key(35));
		{
			std::cout << "construct read controller for safe_binary_tree with constructor taking a reference to a tree" << std::endl;
			xstdtsl::safe_binary_tree<int>::read_control cTIC(cTI);
			...
			{
				std::cout << "construct read controller for safe_binary_tree with constructor taking a reference to existing read controller" << std::endl;
				xstdtsl::safe_binary_tree<int>::read_control cTIC2(cTIC);
				std::cout << "confirm read controller reports empty" << std::endl;
				assert(!cTIC2.empty());
				std::cout << "confirm read controller reports existance of all keys in tree" << std::endl;
	...
	}
	{
		...
		xstdtsl::safe_binary_tree<int> cTI;
		{
			std::cout << "construct write controller for safe_binary_tree with constructor taking a reference to a tree" << std::endl;
			xstdtsl::safe_binary_tree<int>::write_control cTIC(cTI);
			std::cout << "insert an element (root)" << std::endl;
			cTIC.insert(20);
			std::cout << "insert an element (right child)" << std::endl;
			cTIC.insert(30);
		...
		assert(cTI.has_key(35));
		{
			std::cout << "construct another write controller for safe_binary_tree with constructor taking a reference to a tree" << std::endl;
			xstdtsl::safe_binary_tree<int>::write_control cTIC(cTI);
			std::cout << "confirm all elements are in the tree controller" << std::endl;
			assert(cTIC.has_key(5));
			assert(cTIC.has_key(10));
...

	{
		...
		{
			xstdtsl::safe_binary_tree<int> cTI2(cTI);
	...
	}
	{
		...
		{
			xstdtsl::safe_binary_tree<int> cTI2;
